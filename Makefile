...
#    Updated: 2024/09/15 15:07:30 by mrhelmy          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME_SRCS = main.c execute/execute_command.c execute/execute_builtin.c execute/modify_args.c execute/parse_execute.c\
